...
Revision ID: 97cbce78533d
Revises: 
Create Date: 2021-02-17 18:16:03.579837
...
def upgrade():
    ...
    sa.Column('target_time', sa.String(length=120), nullable=True),
    ...
    sa.Column('status_text', sa.String(length=300), nullable=False),
    sa.Column('status_task', sa.Boolean(), nullable=False),
    sa.Column('top_date', sa.String(length=120), nullable=False),
